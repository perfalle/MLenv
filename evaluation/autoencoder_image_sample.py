...
def autoencoder_image_sample(dataloader, encoder, decoder, classnames, n_samples_per_class=21):
    ...
    for i in range(n_samples_per_class):
        for j in range(n_classes):
            ...
            original_ax.imshow(original_image, vmin=0, vmax=1)
            latent_ax.imshow(latent_image, vmin=-1, vmax=1, cmap=plt.get_cmap('seismic'))
            reconstr_ax.imshow(reconstr_image, vmin=0, vmax=1)
